...
public interface BusRouteInfoConst {
    ...
    String ROUTE_CD = "ROUTE_CD";
    String ROUTE_NO = "ROUTE_NO";
    String ROUTE_TP = "ROUTE_TP";
    String RUN_DIST_HALF = "RUN_DIST_HALF";
    String RUN_TM = "RUN_TM";
    String START_NODE_ID = "START_NODE_ID";
    String START_STOP_ID = "START_STOP_ID";
    String TURN_END = "TURN_END";
    String TURN_END_SAT = "TURN_END_SAT";
    String TURN_END_SUN = "TURN_END_SUN";
    String TURN_NODE_ID = "TURN_NODE_ID";
    String TURN_START = "TURN_START";
    String TURN_START_SAT = "TURN_START_SAT";
    String TURN_START_SUN = "TURN_START_SUN";
    String TURN_STOP_ID = "TURN_STOP_ID";
}
